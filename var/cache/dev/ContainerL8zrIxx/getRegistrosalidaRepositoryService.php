 ...
 */
class getRegistrosalidaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RegistrosalidaRepository' shared autowired service.
     *
     * @return \App\Repository\RegistrosalidaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RegistrosalidaRepository.php';

        return $container->privates['App\\Repository\\RegistrosalidaRepository'] = new \App\Repository\RegistrosalidaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
