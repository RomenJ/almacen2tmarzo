 ...
 */
class getObjetosalmacenRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObjetosalmacenRepository' shared autowired service.
     *
     * @return \App\Repository\ObjetosalmacenRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObjetosalmacenRepository.php';

        return $container->privates['App\\Repository\\ObjetosalmacenRepository'] = new \App\Repository\ObjetosalmacenRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
